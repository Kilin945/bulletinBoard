                ...
                <div class="card mb-4 no-print">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="${pageContext.request.contextPath}/bulletins/${bulletin.id}/edit" 
                    ...
                    <div class="card attachment-card">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <p class="mb-2">${bulletin.attachmentFilename}</p>
    ...
    <script>
        ...
        function confirmDelete(id, title) {
            ...
            document.getElementById('deleteForm').action = 
                '${pageContext.request.contextPath}/bulletins/' + id + '/delete';
